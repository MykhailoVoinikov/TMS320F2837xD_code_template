...
{
	EALLOW;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES0) = 0x5;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES0) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES1) = 0x3;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES1) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES2) = 0xFFF;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES2) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES3) = 0x3F;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES3) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES4) = 0x7;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES4) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES6) = 0x3;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES6) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES7) = 0xF;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES7) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES8) = 0x7;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES8) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES9) = 0x3;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES9) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES11) = 0x10003;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES11) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES13) = 0xF;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES13) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES14) = 0xFF;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES14) = 0;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES16) = 0x70000;
	HWREG(DEVCFG_BASE + SYSCTL_O_SOFTPRES16) = 0;
	EDIS;
}
